 ...
 */
function coordinateAdd<T extends Coordinate>(lhs: T, rhs: T | number, constructor: CoordinateConstructor<T>): T {
 ...
 */
function coordinateSubtract<T extends Coordinate>(lhs: T, rhs: T | number, constructor: CoordinateConstructor<T>) {
	if (typeof rhs === "number") return new constructor(lhs.x - rhs, lhs.y - rhs);
	else return new constructor(lhs.x - rhs.x, lhs.y - rhs.y);
}
 ...
 */
function coordinateMultiply<T extends Coordinate>(lhs: T, rhs: T | number, constructor: CoordinateConstructor<T>) {
	if (typeof rhs === "number") return new constructor(lhs.x * rhs, lhs.y * rhs);
	else return new constructor(lhs.x * rhs.x, lhs.y * rhs.y);
}
 ...
 */
function coordinateDivide<T extends Coordinate>(lhs: T, rhs: T | number, constructor: CoordinateConstructor<T>) {
	if (typeof rhs === "number") return new constructor(lhs.x / rhs, lhs.y / rhs);
	else return new constructor(lhs.x / rhs.x, lhs.y / rhs.y);
}

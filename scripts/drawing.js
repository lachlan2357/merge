...
class DrawError extends Error {
    static polygonNotEnoughVertices(numVertices) {
        return new DrawError(`Drawing a polygon requires at least 1 vertex, however ${numVertices} vertices were provided.`);
    }
}

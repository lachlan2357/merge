 ...
 */ export class InferenceCollection {
    /** The {@link MergeWayTag} this inference object is declared for. */ tag;
    /** All calculations that can be made. */ calculations;
    /** All fallbacks that can be made. */ fallbacks;
    /** The default value to set for this tag in the absence of other possibilities. */ defaultValue;
    /** The function used to format this value. */ formatFn;
    /** The function used to validate this value. */ validateFn;
    /**
	 ...
	 */ constructor(tag, calculations, fallbacks, defaultValue, formatFn, validateFn){
        this.tag = tag;
	 ...
	 */ setDefault(tags, inferredTags) {
        ...
        tags[this.tag] = this.defaultValue.maybe();

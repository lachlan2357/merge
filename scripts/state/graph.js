 ...
 */ export class GraphItem {
    /** Map to keep track of which {@link Dependency Dependencies} each {@link Compute} relies on. */ static dependencyMap = new Map();
    /**
	 ...
	 */ finishCalculation() {
        ...
        if (dependencyAccesses === undefined) throw DependencyError.untrackedComputationFinished(this);
...
/** Errors relating to the automatic dependency management system. */ class DependencyError extends MessageBoxError {
    /**

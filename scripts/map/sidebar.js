...
function show(wayId) {
    ...
    while (DRAWN_TAGS.lastChild)
        DRAWN_TAGS.removeChild(DRAWN_TAGS.lastChild);
    while (OTHER_TAGS.lastChild)
        OTHER_TAGS.removeChild(OTHER_TAGS.lastChild);
    ...
    for (const tag of allTags) {
        ...
        if (usedTags.includes(tag))
            DRAWN_TAGS.append(tagRow);
        else
            OTHER_TAGS.append(tagRow);
    }
    // show sidebar

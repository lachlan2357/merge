 ...
 */ export function show(wayId) {
    ...
    for (const tag of allTags){
        ...
        if (originalValue === undefined && inferredValueRaw !== undefined) {
            ...
            const iconSpan = new ElementBuilder("span").addClasses("inference-icon").tooltip("This value has been inferred", "left").children(icon).build();
...
/** Close the sidebar. */ export function hide() {

...
const settingsStorage = {
    ...
    darkMode: new BooleanSetting("Dark Mode", "dark-mode", "Whether to use the dark theme for the application.", window.matchMedia("(prefers-color-scheme: dark)").matches, true, true, value => document.documentElement.setAttribute("darkmode", value.toString())),

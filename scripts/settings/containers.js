 ...
 */ export class Setting {
    ...
    /** The display name of this setting. */ name;
    /** The key to use when storing persistent data. */ key;
    /** A short description of what this setting changes. */ description;
    /** Whether the value of this setting should be stored to persist across application sessions. */ isPersistent;
    /** Whether this setting should appear and be modifiable by the user in the settings menu. */ inSettingsMenu;
    /** The default value of this setting. */ #defaultValue;
    /** The method to run when the value of this setting changes. */ #onChange;
    /** The current value of this setting. */ #currentValue;
    /**
    ...
    /** Reset this setting to its default value. */ reset() {
...
/** Container for storing a setting represented as a boolean. */ export class BooleanSetting extends Setting {
...
/** Container for storing a setting represented as a url. */ export class UrlSetting extends Setting {
    configureInputElement(builder) {
